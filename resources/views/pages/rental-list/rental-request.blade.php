...
@section('pages')
<div class="px-4 pt-6">
    <h1 class="text-[20px] font-bold mb-10">Rental Requests</h1>
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="flex justify-center px-6 py-3 text-center">
                        <div class="">
                            ...
                            <a href="/manage-rental/{{ $rental->id }}/approved">
                                <button
                            ...
                            <a href="/manage-rental/{{ $rental->id }}/declined">
                                <button
                                    class="flex items-center hover:bg-[#FF0000] text-[#FF0000] hover:text-white py-1 px-2 mb-2 border border-[#FF0000] rounded font-medium">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-2 mr-3" fill="currentColor"
                                        viewBox="0 0 384 512">
                                        <!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        <path
                            ...
                            <a href="/manage-rental/rental-detail/{{ $rental->id }}">
                                <button
                                    class="flex items-center px-2 py-1 mb-2 font-medium text-blue-500 border border-blue-500 rounded hover:bg-blue-500 hover:text-white">
